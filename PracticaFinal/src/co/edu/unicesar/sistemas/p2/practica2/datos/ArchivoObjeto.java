...
public class ArchivoObjeto implements IAccesoDatos {
    ...
    public Publicacion buscarPublicacion(String isbn) throws ExcepcionAccesoDatos {
      ...
      return encontrarPublicacionEn(lista,isbn);
    }

    @Override
    public Publicacion eliminarPublicacion(String isbn) throws ExcepcionAccesoDatos {
       List<Publicacion> lista=leerPublicaciones();
       Publicacion buscar=encontrarPublicacionEn(lista,isbn);
     if(buscar==null){
    ...
    private Publicacion encontrarPublicacionEn(List<Publicacion> lista,String isbn) throws ExcepcionAccesoDatos{
     if(lista.size()==0)
